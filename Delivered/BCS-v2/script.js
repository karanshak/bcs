(function () {
  ...
  // language selector according to country name
  document.addEventListener("DOMContentLoaded", function () {
    // Select elements and add classes
    addClassByContent("button.dropdown-toggle", "English (US)", "us");
    addClassByContent("button.dropdown-toggle", "Nederlands", "netherlands");
    addClassByContent("button.dropdown-toggle", "Deutsch", "netherlands");

    addClassByContent("a", "English (US)", "us");
    addClassByContent("a", "Nederlands", "netherlands");
    addClassByContent("a", "Deutsch", "netherlands");
  });

  // Function to add class based on content
  function addClassByContent(selector, text, className) {
  ...
  // show view more if more than 3 section in home page
  document.addEventListener("DOMContentLoaded", function () {
    var categoryElements = document.querySelectorAll(".category-name");

    categoryElements.forEach(function (categoryElement) {
      var sectionNameElements =
        categoryElement.querySelectorAll(".section-name");
  ...
  // Get all elements with the class "statuLink"
  var myLinks = document.getElementsByClassName("statuLink");

  // Loop through all elements with the class "statuLink"
  for (var i = 0; i < myLinks.length; i++) {
    var currentLink = myLinks[i];

    // Check if the href attribute is empty or contains only whitespace
    if (
      !currentLink.getAttribute("href") ||
      currentLink.getAttribute("href").trim() === ""
    ) {
      // If empty or contains only whitespace, hide the anchor tag
